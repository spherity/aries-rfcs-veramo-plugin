## API Report File for "aries-veramo-plugin"
...
// Warning: (ae-unresolved-inheritdoc-reference) The @inheritDoc reference could not be resolved: The package "aries-veramo-plugin" does not have an export "IMyAgentPlugin"
//
// @beta (undocumented)
